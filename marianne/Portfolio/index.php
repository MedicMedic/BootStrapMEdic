...
<html>
   ...
   <body data-bs-spy = "scroll" data-bs-target = ".navbar">
      <nav class = "navbar navbar-expand-lg navbar-dark bg-dark fixed-top d-flex justify-content-between">
         <span class = "text-light">The Duck Zone</span>
         <ul class = "navbar-nav">
            <li class="nav-item"><a class = "nav-link" href = "#home">Home</a></li>
            <li class="nav-item"><a class = "nav-link" href = "#about">About Me</a></li>
            <li class="nav-item"><a class = "nav-link" href = "#product">Cool Stuff I Make</a></li>
            <li class="nav-item"><a class = "nav-link" href = "#contact">Hire Me (contact information)</a></li>
         </ul>
      </nav>

      <section id = "home" style = "background: #fee1f4; text-align:center;" alignment = "center">
         <h1 style = "background: #fea6f4;"class="mt-4 p-5 text-black rounded">Marianne Edic</h1>
         <img src="pic/medichumanpic.jpg" class= "rounded" width="200" height="200">
         <p>Everything weird thing you see I do is for my own amusement, not yours.</p>
         <p>But it sure would be nice if you were amused too.</p>
         <a href="https://www.youtube.com/channel/UC1IQIrczvhfe6wksC_k4nKw" class="btn btn-warning" role="button">My collaborative works</a>
         <a href="https://github.com/MedicMedic" class="btn btn-secondary" role="button">My coding projects</a>
      </section>
